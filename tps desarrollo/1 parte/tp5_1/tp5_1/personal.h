...
public:
    personal(int codigo, string descripcion, string fecha, int cantPersonas,int cantServicios, int personas_extra): 
    evento(codigo, descripcion, fecha, cantPersonas, cantServicios), 
